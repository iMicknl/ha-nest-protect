...
async def test_get_access_token_from_cookies_success(socket_enabled, no_timeout_client):
    ...
    client = await no_timeout_client(app)
...
@pytest.mark.enable_socket
async def test_get_access_token_from_cookies_error(socket_enabled, no_timeout_client):
...
@pytest.mark.enable_socket
async def test_get_first_data_success(socket_enabled, no_timeout_client):
