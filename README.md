THIS IS AN AI AGENT VIBE-CODE FORK TRYING TO PORT THE HA-HELPER-CHROME-EXTENSION TO FIREFOX! USED SYSTEM Perplexity Computer, using Claude Sonnet 4.6. Firefox port tested working
